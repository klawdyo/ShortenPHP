...
/****************************************************************************************************
    ...
    ------------------------------------------------
       ...
       url: http://caiu.nu/_shared/API.php?type=string&url=suaURL 
        method: GET
      
    ------------------------------------------------
      HOW TO
    ------------------------------------------------
      $url = new Shorten('cai.nu');
 ...
 *******************************/
     ...
     */
    public $shortenUrl = 'http://caiu.nu/_shared/API.php';
    
     /*
      @var $defaultParams
      Parâmetros padronizados que serão enviados em todas as requisições
     */
    public $defaultParams = array('type' => 'string');
