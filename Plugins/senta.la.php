...
/****************************************************************************************************
    ...
    ------------------------------------------------
       ...
       url: http://senta.la/api.php?&dever=encurtar&format=(XML / JSON / SIMPLE)&
 ...
 *******************************/
     ...
     */
    public $shortenUrl = 'http://senta.la/api.php';
    
     /*
      @var $defaultParams
      Parâmetros padronizados que serão enviados em todas as requisições
     */
    public $defaultParams = array('dever' => 'encurtar', 'format'=>'simple');
